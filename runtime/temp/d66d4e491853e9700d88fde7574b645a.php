<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpstudy_pro\WWW\tp5\shop\public/../application/admin\view\category\index.html";i:1567312313;s:70:"D:\phpstudy_pro\WWW\tp5\shop\application\admin\view\public\header.html";i:1567312313;s:70:"D:\phpstudy_pro\WWW\tp5\shop\application\admin\view\public\footer.html";i:1567312313;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/admin/hui/static/h-ui.admin/skin/default/skin.css"
          id="skin"/>
...
<div class="page-container">
    <img src="<?php echo url('index/staticimage'); ?>" alt="地址静态图">

    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a class="btn btn-primary radius"
                                                                onclick="o2o_s_edit('添加生活服务分类','<?php echo url('category/add'); ?>','','300')"
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="text-c listorder">
                    <input size="3" data-id="<?php echo $vo['id']; ?>" name="listorder" value="<?php echo $vo['listorder']; ?>"/>
                </td>
                <td><?php echo $vo['create_time']; ?></td>
                <td class="td-status">
                    <a href="<?php echo url('category/status',['id'=>$vo['id'], 'status'=>$vo['status']==1?0:1]); ?>" title="点击修改状态">
                ...
                <td class="td-manage">
                    ...
                    <a style="text-decoration:none" class="ml-5"
                       onClick="o2o_s_edit('编辑','<?php echo url('category/edit', ['id'=>$vo['id']]); ?>','',300)" href="javascript:;"
                       title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"
                       onClick="o2o_del('<?php echo url('category/status', ['id'=>$vo['id'], 'status'=>-1]); ?>')" href="javascript:;"
                       title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                </td>
...
<script>
    $('.listorder input').on('blur', (e) => {
        let id = e.currentTarget.dataset.id
        let listorder = e.currentTarget.value
        let postData = {
            'id': id,
            'listorder': listorder
        }

        let url = "<?php echo url('category/listorder'); ?>"
